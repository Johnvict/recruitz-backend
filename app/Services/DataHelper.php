...
trait DataHelper
{
    ...
    public static $workExperienceCreateValidationRule = [
        'job_title'     => 'required|string|max:50',
        'company_name'  => 'required|string|max:50',
        'job_summary'   => 'required|string|min:20|max:225',
        'still_active'  => 'boolean',
        'started_at'    => 'required|date|date|before_or_equal:today',
        'left_at'       => 'required_unless:still_active,=,true|date|date|before_or_equal:today'
    ];

    public static $workExperienceUpdateValidationRule = [
        'id'            => 'required|integer',
        'job_title'     => 'required|string|max:50',
        'company_name'  => 'required|string|max:50',
        'job_summary'   => 'required|string|min:20|max:225',
